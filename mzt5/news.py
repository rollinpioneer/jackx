...
def preprocess_function(examples):
    # XLSum数据集中通常包含'text'和'summary'字段，根据具体结构调整
...
training_args = Seq2SeqTrainingArguments(
    output_dir=os.path.abspath(os.path.join(os.path.dirname(__file__), "../results/news-creative")),
    ...
    logging_dir=os.path.abspath(os.path.join(os.path.dirname(__file__), "../results/news-creative/logs")),
    logging_steps=100,
    save_strategy="epoch",
)
...
# 保存最终模型
output_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../results/news-creative/final_model"))
